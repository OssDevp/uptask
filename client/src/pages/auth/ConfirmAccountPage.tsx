...
import { UserConfirmAccountForm } from "@/types/index";
...
export default function ConfirmAccountPage() {
  ...
  const handleChange = (token: UserConfirmAccountForm['token']) => {
    setToken(token);
  }

  const handleCompleted = (token: UserConfirmAccountForm['token']) => {
    mutate({ token });
  }
